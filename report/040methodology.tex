...
Above algorithm only accept the polynomials with non-zero roots, therefore 
before using the Algorithm~\ref{alg4}, we need to remove the zero roots of
original $P$. Then we used Algorithm~\ref{alg4} with $P(x)$ and $P(-x)$ to get
